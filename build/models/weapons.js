...
var WeaponStore = /** @class */ (function () {
    function WeaponStore() {
    }
    WeaponStore.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("cannot get weapons ".concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    WeaponStore.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    WeaponStore.prototype.create = function (b) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [b.name, b.type, b.weight])];
                    case 2:
                        result = _a.sent();
                        book = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new book ".concat(name, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    WeaponStore.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
